...
We designed the benchmark metric for the challenge to be used to evaluate new approaches in the context of the current state-of-the-art enhancer prioritization methods. Following the guidelines in our submissions and data pages please self-evaluate using the [benchmark metric](https://github.com/AllenInstitute/EnhancerBenchmark/blob/main/code/BenchmarkMetric.R), and enhancer validation tables provided in assets of this github. We encourage method developers to then create a pull request to our leaderboard page with your results and submission files.
